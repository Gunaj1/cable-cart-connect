...
import { Cable, ShoppingCart, Phone, Mail, MapPin, Facebook, Twitter, Linkedin, Instagram, X } from 'lucide-react';
...
const Index = () => {
  ...
  const removeFromCart = (productId: string) => {
    ...
    if (removedItem) {
      setProducts(prev => prev.map(p => p.id === productId ? { ...p, stock: (p.stock ?? 0) + removedItem.quantity } : p));
    }
  ...
  const updateQuantity = (productId: string, newQuantity: number) => {
    ...
    setProducts(prev => prev.map(p => p.id === productId ? { ...p, stock: (p.stock ?? 0) - quantityDiff } : p));
  };
      ...
      <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
        <div className="bg-white rounded-2xl w-full max-w-5xl max-h-[90vh] overflow-y-auto shadow-2xl">
          <div className="sticky top-0 bg-gradient-to-r from-blue-600 to-gray-600 z-10 px-8 py-6 flex justify-between items-center rounded-t-2xl">
            ...
            <button onClick={onClose} className="text-white hover:text-gray-2 00 transition-colors p-2 rounded-full hover:bg-white/20">
              <X className="w-7 h-7" />
            </button>
          </div>
          <div className="p-8">
    ...
    <ErrorBoundary>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-gray-50">
        ...
        <div
          ...
          style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1601597111158-2fceff292cdc?auto=format&fit=crop&q=80")' }}
        >
        ...
        <div id="contact" className="bg-gradient-to-br from-blue-900 via-gray-900 to-blue-800 text-white py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-blue-200">We're here to help with all your cable needs</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="p-3 bg-white/20 rounded-xl hover:bg-blue-600 transition-all duration-300 transform hover:scale-110"><Facebook className="w-6 h-6" /></a>
                  <a href="#" className="p-3 bg-white/20 rounded-xl hover:bg-blue-600 transition-all duration-300 transform hover:scale-110"><Twitter className="w-6 h-6" /></a>
                  <a href="#" className="p-3 bg-white/20 rounded-xl hover:bg-blue-600 transition-all duration-300 transform hover:scale-110"><Linkedin className="w-6 h-6" /></a>
                  <a href="#" className="p-3 bg-white/20 rounded-xl hover:bg-blue-600 transition-all duration-300 transform hover:scale-110"><Instagram className="w-6 h-6" /></a>
                </div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
        ...
        <ProductQuickView
          ...
          onAddToCart={(product, quantity) => { for (let i = 0; i < quantity; i++) addToCart(product); }}
        ...
        <ProductCompareDrawer
          ...
          onViewFullComparison={() => { setIsCompareDrawerOpen(false); setIsFullCompareOpen(true); }}
        />
        ...
        <CompareTable
          ...
          onAddToCart={addToCart}
          onClearComparison={() => { clearComparison(); setIsFullCompareOpen(false); }}
        />
...
const categories = [{
  ...
  name: 'Patchcords',
  products: [{
    id: 'pc1', name: 'Cat 6 STP', price: 29.99, image: cat6StpPatchcord, category: 'Patchcords',
    ...
    id: 'pc2', name: 'Cat 6 FTP', price: 27.99, image: cat6FtpPatchcord, category: 'Patchcords',
    ...
    id: 'pc3', name: 'Cat 6 UTP', price: 25.99, image: cat6UtpPatchcord, category: 'Patchcords',
    ...
    id: 'pc4', name: 'Cat 5e STP', price: 24.99, image: cat5eStpPatchcord, category: 'Patchcords',
    ...
    id: 'pc5', name: 'Cat5e FTP', price: 22.99, image: cat5eFtpPatchcord, category: 'Patchcords',
    ...
    id: 'pc6', name: 'Cat5e UTP', price: 20.99, image: cat5eUtpPatchcord, category: 'Patchcords',
  ...
  products: [{
    id: 'lan1', name: 'Cat 5e Flat', price: 35.99, image: cat5eFlatLan, category: 'Cat5e LAN Cables',
    ...
    id: 'lan2', name: 'Cat5e 2 pair', price: 32.99, image: cat5e2pairLan, category: 'Cat5e LAN Cables',
    ...
    id: 'lan3', name: 'Cat 5e Armored', price: 45.99, image: cat5eArmoredLan, category: 'Cat5e LAN Cables',
    ...
    id: 'lan4', name: 'Cat 5e FTP', price: 38.99, image: cat5eFtpLan, category: 'Cat5e LAN Cables',
    ...
    id: 'lan5', name: 'Cat 5e STP', price: 36.99, image: cat5eStpLan, category: 'Cat5e LAN Cables',
    ...
    id: 'lan6', name: 'Cat 5e UTP', price: 34.99, image: cat5eUtpLan, category: 'Cat5e LAN Cables',
    ...
    id: 'lan7', name: 'Cat 5e Outdoor', price: 42.99, image: cat5eOutdoorLan, category: 'Cat5e LAN Cables',
  ...
  products: [{
    id: 'cat1', name: 'Cat 6 Flat', price: 45.99, image: cat6FlatLan, category: 'Cat 6 LAN Cable',
    ...
    id: 'cat2', name: 'Cat 6 Armored', price: 55.99, image: cat6ArmoredLan, category: 'Cat 6 LAN Cable',
    ...
    id: 'cat3', name: 'Cat 6 STP', price: 48.99, image: cat6StpLan, category: 'Cat 6 LAN Cable',
    ...
    id: 'cat4', name: 'Cat  6 FTP', price: 46.99, image: cat6FtpLan, category: 'Cat 6 LAN Cable',
    ...
    id: 'cat5', name: 'Cat 6 UTP', price: 44.99, image: cat6UtpLan, category: 'Cat 6 LAN Cable',
    ...
    id: 'cat6', name: 'Cat 6 Outdoor', price: 52.99, image: cat6OutdoorLan, category: 'Cat 6 LAN Cable',
  ...
  name: 'CCTV Cable',
  products: [{
    id: 'cctv1', name: 'CCTV Cable 3+1', price: 29.99, image: cctv3plus1Cable, category: 'CCTV Cable',
    ...
    id: 'cctv2', name: 'CCTV Cable 4+1', price: 34.99, image: cctv4plus1Cable, category: 'CCTV Cable',
  ...
  products: [{
    id: 'tel1', name: 'Standard Telephone Cable', price: 19.99, image: telephoneCable, category: 'Telephone Cable',
  ...
  name: 'Computer Cords',
  products: [{
    id: 'cc1', name: 'Desktop CPU Power Cord', price: 15.99, image: desktopPowerCord, category: 'Computer Cords',
    ...
    id: 'cc2', name: 'Laptop Notebook Adaptor Power Cord', price: 18.99, image: 'https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?auto=format&fit=crop&q=80', category: 'Computer Cords',
  ...
  name: 'Lift Cables',
  products: [{
    id: 'lift1', name: 'Standard Lift Cable', price: 149.99, image: liftCable, category: 'Lift Cables',
  ...
  name: 'Speaker Cable',
  products: [{
    id: 'speaker1', name: 'Standard Speaker Cable', price: 39.99, image: speakerCable, category: 'Speaker Cable',
