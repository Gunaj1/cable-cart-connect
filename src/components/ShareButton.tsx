...
const ServicesSection = () => {
  const services = [
    ...
    },
    {
      ...
      description:
        'All products undergo rigorous testing and come with manufacturer warranties and quality guarantees.',
    },
    {
      icon: Headphones,
      title: '24/7 Support',
      description:
        'Round-the-clock customer support for technical queries, order assistance, and after-sales service.',
    },
    {
      icon: Award,
      title: 'OEM & Branding Services',
      description:
        'Comprehensive OEM manufacturing and private label solutions with custom branding options for bulk orders.',
    },
    {
      icon: Settings,
      title: 'Certified Products',
      description:
        'ISO certified products meeting international standards with proper documentation and testing reports.',
    },
    {
      icon: Zap,
      title: 'Custom Solutions',
      description:
        'Tailored cable solutions for specific requirements including bulk orders and custom specifications.',
    },
  ];
