...
>(({ className, ...props }, ref) => (
  <div className="fixed left-0 right-0 top-[72px] w-screen flex justify-start z-[9999]">
    <NavigationMenuPrimitive.Viewport
      className={cn(
        "origin-top w-screen h-[var(--radix-navigation-menu-viewport-height)] overflow-hidden border-b bg-background text-foreground shadow-2xl",
